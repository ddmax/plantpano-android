package net.ddmax.plantpano.ui.custom;
...
public class SettingItem extends RelativeLayout {
    ...
    public void getCustomStyle(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            } else if (attr == R.styleable.SettingView_leftIconTint){
                // 设置左侧图标填充颜色
                mIvLeftIcon.setColorFilter(a.getColor(attr, Color.LTGRAY));
